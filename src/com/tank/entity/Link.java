...
public class Link {
	...
	/*
	 * define equivalence relation between two different Links
	 * 2017/3/21 16:37
	 */
	public boolean equals(Link a) {
		if(this.srcNodeId.equals(a.srcNodeId) && this.srcTp.equals(a.srcTp) && this.dstNodeId.equals(a.dstNodeId) && this.dstTp.equals(a.dstTp))
			return true;
		return false;
	}
